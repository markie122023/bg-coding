        ...
        <div class="container desktop__menu__wrapper">
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-6">
                    <div class="headerarea__left">
                        <div class="headerarea__left__logo">
                            ...
                            <a href="/"><img style="height: 50px;" src="logo-mini.svg" alt="logo"></a>
                        </div>
                ...
                <div class="col-xl-7 col-lg-7 main_menu_wrap">
                    ...
                    <h2 class="text-center">Braingainspa Coding </h2>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="headerarea__right">
                        ...
                        <div class="headerarea__button">
                            <a href="https://app.braingainspa.com/register">Get Started Free</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="mobile-logo">
                        <a class="logo__dark" href="/"><img style="height: 40px;"  src="logo-mini.svg" alt="logo"></a>
                    </div>
                </div>
                <div class="col-6">
